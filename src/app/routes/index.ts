...
import { PassengerManagementRoutes } from "../modules/passengerManagement/passengerManagement.route";
...
import {
  LostAndFoundRoutes,
  LostAndFoundAdminRoutes,
} from "../modules/lostAndFound/lostAndFound.route";
...
const apiRoutes = [
  ...
  },
  {
    ...
    route: PassengerManagementRoutes,
  },
  {
    path: "/cars",
    route: CarRoutes,
  ...
  },
  {
    ...
    route: DemandIntelligenceRoutes,
  },
  {
    path: "/live-trips",
