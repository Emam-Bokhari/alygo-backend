...
export const REFERRAL_RULES = {
  ...
  driver: [
    ...
    },
    {
      ...
      description: `The referee must register using your code and complete ${REFERRAL_CONSTANTS.DRIVER_REQUIRED_RIDES} verified passenger trips within ${REFERRAL_CONSTANTS.DRIVER_VALIDITY_DAYS} days.`,
    },
    {
      title: "Receive Payout",
      description: `Once verified, your bonus reward ($${REFERRAL_CONSTANTS.DRIVER_REFERRAL_REWARD} per driver) is directly deposited into your payout account within 48 hours.`,
    },
  ],
};
