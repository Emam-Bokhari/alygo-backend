...
exports.default = {
    ...
    referral: {
        passenger: {
            ...
            rewardAmount: parseFloat(process.env.REFERRAL_PASSENGER_REWARD_AMOUNT || "20"),
            rewardCurrency: process.env.REFERRAL_PASSENGER_REWARD_CURRENCY || "USD",
            qualificationType: process.env.REFERRAL_PASSENGER_QUALIFICATION_TYPE || "rides",
            requiredCompletedTrips: parseInt(process.env.REFERRAL_PASSENGER_REQUIRED_TRIPS || "1"),
            qualificationDays: parseInt(process.env.REFERRAL_PASSENGER_QUALIFICATION_DAYS || "30"),
        ...
        driver: {
            ...
            rewardAmount: parseFloat(process.env.REFERRAL_DRIVER_REWARD_AMOUNT || "100"),
            rewardCurrency: process.env.REFERRAL_DRIVER_REWARD_CURRENCY || "USD",
            requiredCompletedTrips: parseInt(process.env.REFERRAL_DRIVER_REQUIRED_TRIPS || "10"),
            qualificationDays: parseInt(process.env.REFERRAL_DRIVER_QUALIFICATION_DAYS || "30"),
    ...
    driverRewards: {
        ...
        timezone: process.env.DRIVER_REWARDS_TIMEZONE || "Asia/Dhaka",
