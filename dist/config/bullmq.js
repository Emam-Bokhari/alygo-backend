...
exports.driverVisibilityQueue = new bullmq_1.Queue(exports.QUEUE_NAMES.DRIVER_VISIBILITY, {
    connection: connectionOptions,
    defaultJobOptions: {
        attempts: 3,
        backoff: {
...
exports.radiusExpansionQueue = new bullmq_1.Queue(exports.QUEUE_NAMES.RADIUS_EXPANSION, {
    connection: connectionOptions,
    defaultJobOptions: {
        attempts: 3,
        backoff: {
...
exports.driverAvailabilityCheckQueue = new bullmq_1.Queue(exports.QUEUE_NAMES.DRIVER_AVAILABILITY_CHECK, {
    connection: connectionOptions,
    defaultJobOptions: {
        attempts: 3,
        backoff: {
