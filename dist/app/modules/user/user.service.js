...
const createUserToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { referredByCode } = payload,
      userData = __rest(payload, ["referredByCode"]);
    ...
    yield referral_service_1.ReferralService.getOrCreateReferralCode(
      createUser._id.toString(),
    );
    // Link referral if referredByCode is passed
    if (referredByCode) {
      yield referral_service_1.ReferralService.handleReferralSignup(
        createUser._id.toString(),
        referredByCode,
      );
    }
...
const switchProfileToDB = (userId, role) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (![user_1.USER_ROLES.USER, user_1.USER_ROLES.DRIVER].includes(role))
      throw new ApiErrors_1.default(
        400,
        "Role is must be either 'USER' or 'DRIVER'",
      );
