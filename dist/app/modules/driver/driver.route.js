...
router.get(
  ...
  driver_controller_1.DriverController.getReservations,
);
router
  .route("/")
  .post(
  ...
  .get(
    authHelper_1.isAuthenticated,
    driver_controller_1.DriverController.getDriverProfile,
  );
router.get(
  "/me/availability",
  authHelper_1.isAuthenticated,
  driver_controller_1.DriverController.getAvailability,
);
router.get(
  "/:driverId/reviews",
  authHelper_1.isAuthenticated,
  review_controller_1.ReviewController.getDriverReviews,
);
router.get(
  "/:driverId/review-summary",
  authHelper_1.isAuthenticated,
  review_controller_1.ReviewController.getDriverReviewSummary,
);
