...
const createDriver = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.user;
    const result = yield driver_service_1.DriverServices.createDriverToDB(id, req.body);
...
const getDriverProfile = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield driver_service_1.DriverServices.getDriverProfileFromDB(req.user.id);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const updateDriver = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.user;
    const result = yield driver_service_1.DriverServices.updateDriverFromDB(id, req.body);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const getAvailability = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield driver_service_1.DriverServices.getDriverAvailability(req.user.id);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const getReservations = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield driver_service_1.DriverServices.getDriverReservationsFromDB(req.user.id, req.query);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
