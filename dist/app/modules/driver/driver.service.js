...
const createDriverToDB = (userId, payload) =>
    ...
    if (processedTaxDocuments && Array.isArray(processedTaxDocuments)) {
      processedTaxDocuments = processedTaxDocuments.map((doc) =>
        Object.assign(Object.assign({}, doc), {
          extractionStatus:
            doc.extractionStatus || driver_constant_1.EXTRACTION_STATUS.PENDING,
          extractedData: doc.extractedData || {},
        }),
      );
    }
    const driverPayload = Object.assign(
      Object.assign({ userId: new mongoose_1.Types.ObjectId(userId) }, payload),
      { taxDocuments: processedTaxDocuments || [] },
    );
    const driver = yield driver_model_1.Driver.create(driverPayload);
    return driver;
  });
const getDriverProfileFromDB = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateDriverFromDB = (userId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const existingUser = yield user_model_1.User.isExistUserById(userId);
    if (!existingUser) {
      throw new ApiErrors_1.default(404, "User not found");
    ...
    const _a = payload,
      { userId: _ } = _a,
      updatePayload = __rest(_a, ["userId"]);
    // Process taxDocuments if present
    if (
      updatePayload.taxDocuments &&
      Array.isArray(updatePayload.taxDocuments)
    ) {
...
const getDriverAvailability = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const driver = yield driver_model_1.Driver.findOne({
      userId: new mongoose_1.Types.ObjectId(userId),
    });
...
const getDriverReservationsFromDB = (driverUserId, query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (driver === null || driver === void 0 ? void 0 : driver.serviceAreaId) {
      const serviceArea = yield serviceArea_model_1.ServiceArea.findById(
        driver.serviceAreaId,
      );
      driverTimezone =
        (serviceArea === null || serviceArea === void 0
          ? void 0
          : serviceArea.timezone) || "UTC";
    }
    // Calculate start/end of day in driver's timezone
    const startOfDay = (0, timezoneHelper_1.getCurrentTimeInTimezone)(
      driverTimezone,
    )
      .startOf("day")
      .toUTC()
      .toJSDate();
    const endOfDay = (0, timezoneHelper_1.getCurrentTimeInTimezone)(
      driverTimezone,
    )
      .endOf("day")
      .toUTC()
    ...
    const reservationQuery = new queryBuilder_1.default(
      ride_model_1.Ride.find(filterQuery).populate(
        "userId",
