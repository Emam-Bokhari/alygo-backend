...
router.get(
  ...
  referral_controller_1.ReferralController.getUserInfo,
);
router.get(
  "/driver-info",
  (0, auth_1.default)(
  ...
  referral_controller_1.ReferralController.getDriverInfo,
);
router.get(
  "/driver-progress",
  (0, auth_1.default)(
  ...
  referral_controller_1.ReferralController.getDriverProgress,
);
router.get(
  "/driver-payouts",
  (0, auth_1.default)(
  ...
  referral_controller_1.ReferralController.getDriverPayouts,
);
