...
const handleReferralSignup = (refereeId, referralCode) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield user_model_1.User.findByIdAndUpdate(refereeId, { referredById: referrer._id });
    const referrerRole = referrer.role === user_1.USER_ROLES.DRIVER ? "driver" : "user";
    const initialStatus = referrer.role === user_1.USER_ROLES.DRIVER
        ? referral_interface_1.REFERRAL_STATUS.IN_PROGRESS
        : referral_interface_1.REFERRAL_STATUS.JOINED;
    const rewardAmount = referrer.role === user_1.USER_ROLES.DRIVER
 ...
 */
const updateDriverReferralProgress = (refereeId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const expiryDate = new Date(joinedAt.getTime() +
        referral_constant_1.REFERRAL_CONSTANTS.DRIVER_VALIDITY_DAYS * 24 * 60 * 60 * 1000);
    ...
    if (ridesCompleted >= referral_constant_1.REFERRAL_CONSTANTS.DRIVER_REQUIRED_RIDES) {
 ...
 */
const getUserReferralInfo = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalJoin = referrals.filter((ref) => { var _a; return (_a = ref.refereeId) === null || _a === void 0 ? void 0 : _a.verified; }).length;
    const currentDiscount = totalJoin * referral_constant_1.REFERRAL_CONSTANTS.USER_REFERRAL_REWARD;
    const referralList = referrals.map((ref) => {
        ...
        return ({
            ...
            joiningDate: ((_c = ref.refereeId) === null || _c === void 0 ? void 0 : _c.createdAt) || ref.joinedAt,
 ...
 */
const getDriverReferralInfo = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const referralCode = yield getOrCreateReferralCode(userId);
    ...
    const active = referrals.filter((r) => r.status === referral_interface_1.REFERRAL_STATUS.IN_PROGRESS).length;
    const completed = referrals.filter((r) => r.status === referral_interface_1.REFERRAL_STATUS.COMPLETED).length;
    const pendingRewards = referrals
        .filter((r) => r.status === referral_interface_1.REFERRAL_STATUS.COMPLETED &&
 ...
 */
const getDriverReferralProgress = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    // Sync first
    const activeReferrals = yield referral_model_1.Referral.find({
        referrerId: userId,
        referrerRole: "driver",
    ...
    return referrals.map((ref) => {
        ...
        return ({
            ...
            requiredRides: referral_constant_1.REFERRAL_CONSTANTS.DRIVER_REQUIRED_RIDES,
            status: ref.status,
            amount: ref.status === referral_interface_1.REFERRAL_STATUS.COMPLETED ? ref.rewardAmount : 0,
        });
    });
});
/**
 ...
 */
const getDriverPayoutHistory = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const referrals = yield referral_model_1.Referral.find({
        referrerId: userId,
        referrerRole: "driver",
    ...
    return referrals.map((ref) => {
        ...
        return ({
            id: ref._id,
            refereeName: ((_a = ref.refereeId) === null || _a === void 0 ? void 0 : _a.name) || "Unknown Driver",
