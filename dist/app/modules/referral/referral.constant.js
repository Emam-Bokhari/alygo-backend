    ...
    user: [
        {
            ...
            description: "Send your unique referral code or link to friends in your community.",
        },
        {
            title: "Friends Join",
            description: "Ensure your friends register using your referral code and complete their profile verification.",
        },
        {
            title: "Receive Discount",
            description: "Once verified, your subscription discount ($10 per friend) is automatically applied to your account.",
        },
    ],
    driver: [
        {
            title: "Share Your Code",
            description: "Send your unique referral code or link to experienced drivers in your community.",
        },
        {
