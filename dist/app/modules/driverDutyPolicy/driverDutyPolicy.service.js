...
const createDriverDutyPolicyToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Auto-attach parent IDs based on scope type
    if (payload.scopeType && payload.airportId) {
      const airport = yield serviceArea_model_1.ServiceArea.findById(
        payload.airportId,
      );
      if (airport) {
        payload.cityId = airport.cityId;
        if (airport.cityId) {
          const city = yield serviceArea_model_1.ServiceArea.findById(
            airport.cityId,
          );
          if (city) {
            payload.stateId = city.stateId;
            if (city.stateId) {
              const state = yield serviceArea_model_1.ServiceArea.findById(
                city.stateId,
              );
              if (state) {
      ...
      const zone = yield serviceArea_model_1.ServiceArea.findById(
        payload.zoneId,
      );
      if (zone) {
    ...
    const driverDutyPolicy =
      yield driverDutyPolicy_model_1.DriverDutyPolicy.create(payload);
    return driverDutyPolicy;
  });
const getDriverDutyPolicyFromDB = (driverDutyPolicyId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const driverDutyPolicy =
      yield driverDutyPolicy_model_1.DriverDutyPolicy.findById(
        driverDutyPolicyId,
      ).populate([
...
const getAllDriverDutyPoliciesFromDB = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const countResult =
      yield driverDutyPolicy_model_1.DriverDutyPolicy.aggregate(countPipeline);
    const total =
      ((_a = countResult[0]) === null || _a === void 0 ? void 0 : _a.total) ||
      0;
    // Add sort
    ...
    const result =
      yield driverDutyPolicy_model_1.DriverDutyPolicy.aggregate(pipeline);
...
const updateDriverDutyPolicyFromDB = (driverDutyPolicyId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedDriverDutyPolicy =
      yield driverDutyPolicy_model_1.DriverDutyPolicy.findByIdAndUpdate(
        driverDutyPolicyId,
        payload,
...
const deleteDriverDutyPolicyFromDB = (driverDutyPolicyId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const deletedDriverDutyPolicy =
      yield driverDutyPolicy_model_1.DriverDutyPolicy.softDeleteById(
        driverDutyPolicyId,
      );
...
const getActiveDriverDutyPoliciesFromDB = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const searchTerm = query.searchTerm;
    // Build aggregation pipeline
...
const updateDriverDutyPolicyStatusFromDB = (driverDutyPolicyId, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updatedDriverDutyPolicy =
      yield driverDutyPolicy_model_1.DriverDutyPolicy.findByIdAndUpdate(
        driverDutyPolicyId,
...
const getDriverAvailability = (driverId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const timezone =
      (driverLocServiceArea === null || driverLocServiceArea === void 0
        ? void 0
        : driverLocServiceArea.timezone) || "UTC";
    ...
    if (totalDrivingHoursToday >= policy.maxDrivingHoursPerDay) {
      ...
      const blockedUntil = (0, timezoneHelper_1.getCurrentTimeInTimezone)(
        timezone,
      )
        .plus({ days: 1 })
        .startOf("day")
        ...
        if (ride.startedAt && ride.completedAt) {
          ...
          if (continuousDrivingHours >= policy.maxContinuousDrivingHours) {
            ...
            return {
              canReceiveRide: false,
              blockedReason:
                driver_constant_1.DRIVER_BLOCK_REASON.CONTINUOUS_LIMIT,
              blockedUntil,
              remainingHours,
              remainingMinutes: remainingMinutes % 60,
              remainingSeconds: remainingSeconds % 60,
...
const updateDriverAvailability = (driverId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const driver = yield driver_model_1.Driver.findOne({ userId: driverId });
    if (!driver) {
    ...
    const previousCanReceiveRide =
      (_b =
        (_a = driver.availability) === null || _a === void 0
          ? void 0
          : _a.canReceiveRide) !== null && _b !== void 0
        ? _b
        : true;
    ...
    return Object.assign(Object.assign({}, availabilityData), {
