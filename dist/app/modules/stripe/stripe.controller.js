...
const createStripeAccount = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const stripeAccount = yield stripe_service_1.default.createConnectedAccount(user.email, user.id);
    // Update Driver's Stripe account ID
    yield driver_model_1.Driver.findOneAndUpdate({ userId: user.id }, { stripeConnectedAccountId: stripeAccount.id });
...
const getStripeDashboardLink = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const driver = yield mongoose_1.default.model("Driver").findOne({ userId: user.id });
    const connectedAccountId = (driver === null || driver === void 0 ? void 0 : driver.stripeConnectedAccountId) || user.stripeConnectedAccountId;
    if (!connectedAccountId) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Stripe account not connected");
    }
    const dashboardLink = yield stripe_service_1.default.createLoginLink(connectedAccountId);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const getAccountDetails = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const driver = yield mongoose_1.default.model("Driver").findOne({ userId: user.id });
    const connectedAccountId = (driver === null || driver === void 0 ? void 0 : driver.stripeConnectedAccountId) || user.stripeConnectedAccountId;
    if (!connectedAccountId) {
    ...
    const account = yield stripe_service_1.default.retrieveAccount(connectedAccountId);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const createCheckoutSession = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!ride) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "Ride not found or unauthorized.");
    }
    if (ride.status !== ride_constant_1.RIDE_STATUS.COMPLETED) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Ride must be completed before payment.");
    }
    if (ride.payment.status === ride_constant_1.PAYMENT_STATUS.PAID) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "This ride is already paid.");
    }
    ...
    if (!user) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "Passenger user profile not found.");
    }
    // Handle wallet-only payment direct completion internally
    if (chargeAmount === 0) {
        const result = yield ride_service_1.RideServices.completeRidePayment(rideId, ride_constant_1.PAYMENT_METHOD.WALLET);
    ...
    const stripeCustomerId = yield stripe_service_1.default.getOrCreateCustomer(userId, user.email, user.name);
...
const getPaymentStatus = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paymentIntent = yield stripe_service_1.default.retrievePaymentIntent(paymentIntentId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
// Refunds
// ----------------------------------------------------
const refundTransaction = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (transaction.paymentStatus === ride_constant_1.PAYMENT_STATUS.REFUNDED) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Transaction is already refunded.");
    }
    const refundAmount = amount ? Number(amount) : transaction.amount;
    let refundId = "";
    if (transaction.paymentMethod !== ride_constant_1.PAYMENT_METHOD.WALLET &&
        transaction.gatewayTransactionId) {
        const stripeRefund = yield stripe_service_1.default.refundPayment(transaction.gatewayTransactionId, refundAmount);
        refundId = stripeRefund.id;
    }
    else {
        // Refund to Wallet
        const wallet = yield wallet_service_1.WalletService.getOrCreateWallet(transaction.userId);
    ...
    const refundTxn = yield transaction_service_1.TransactionService.createTransaction({
...
const handleWebhook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let event;
    try {
        event = stripe_1.default.webhooks.constructEvent(req.rawBody, signature, config_1.default.stripe.webhookSecret);
    }
    catch (err) {
    ...
    try {
        ...
        console.error(`Error processing Stripe Webhook (${event.type}):`, error.message || error);
        res
