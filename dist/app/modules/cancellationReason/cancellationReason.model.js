...
const cancellationReasonSchema = new mongoose_1.Schema({
    ...
    userType: {
        type: String,
        enum: Object.values(cancellationReason_constant_1.CANCELLATION_REASON_USER_TYPE),
        required: true,
    },
    sortOrder: {
        type: Number,
...
exports.CancellationReason = (0, mongoose_1.model)("CancellationReason", cancellationReasonSchema);
