...
// get notifications
const getNotificationFromDB = (user, query) =>
...
const getRecentActivitiesFromDB = (user) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const adminRecentActivitiesFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notification_model_1.Notification.find({
      type: notification_constant_1.NOTIFICATION_TYPE.ADMIN,
    })
...
const getSingleNotificationFromDB = (user, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const readSingleNotificationToDB = (user, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const adminGetSingleNotificationFromDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notification_model_1.Notification.findOne({
      _id: id,
      type: notification_constant_1.NOTIFICATION_TYPE.ADMIN,
...
const adminReadSingleNotificationToDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notification_model_1.Notification.findOneAndUpdate(
      { _id: id, type: notification_constant_1.NOTIFICATION_TYPE.ADMIN },
      { $set: { read: true } },
      { new: true },
    );
    return result;
