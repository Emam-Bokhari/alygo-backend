...
const getPolicyConfig = (session) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    let policy =
      yield cancellationPolicy_model_1.CancellationPolicy.findOne().session(
        session,
      );
    if (
      !policy ||
      ...
      ((_b =
        (_a = policy.driver) === null || _a === void 0
          ? void 0
          : _a.afterAccept) === null || _b === void 0
        ? void 0
        : _b.driverCompensation) !== undefined
    ) {
      if (policy) {
        yield cancellationPolicy_model_1.CancellationPolicy.deleteMany(
          {},
        ).session(session);
      }
      const [newPolicy] =
        yield cancellationPolicy_model_1.CancellationPolicy.create(
...
const createCancellationPolicyToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const policy =
      yield cancellationPolicy_model_1.CancellationPolicy.findOne();
    if (policy) {
      const updated =
        yield cancellationPolicy_model_1.CancellationPolicy.findByIdAndUpdate(
          policy._id,
          payload,
          { new: true },
        );
    ...
    const createCancellationPolicy =
      yield cancellationPolicy_model_1.CancellationPolicy.create(payload);
...
const getCancellationPolicyFromDB = (_cancellationPolicyId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield getPolicyConfig();
  });
const getAllCancellationPolicyFromDB = (...args_1) =>
...
const getActiveCancellationPoliciesFromDB = (...args_1) =>
  __awaiter(void 0, [...args_1], void 0, function* (_query = {}) {
    const policy = yield getPolicyConfig();
    const result = policy ? [policy] : [];
    return {
...
const getCancellationPolicyByActorAndTriggerFromDB = (actorType, triggerType) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const policy = yield getPolicyConfig();
...
const updateCancellationPolicyToDB = (_cancellationPolicyId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const policy = yield getPolicyConfig();
    const updated =
      yield cancellationPolicy_model_1.CancellationPolicy.findByIdAndUpdate(
...
const updateCancellationPolicyStatusToDB = (_cancellationPolicyId, _status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield getPolicyConfig();
  });
const deleteCancellationPolicyToDB = (_cancellationPolicyId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const policy = yield getPolicyConfig();
    const result =
      yield cancellationPolicy_model_1.CancellationPolicy.softDeleteById(
        policy._id.toString(),
      );
    return result;
  });
