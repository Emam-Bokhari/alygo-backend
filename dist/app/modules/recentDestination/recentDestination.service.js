...
const MAX_RECENT_DESTINATIONS = parseInt(process.env.MAX_RECENT_DESTINATIONS || "20");
/**
 * Get all recent destinations for a user, sorted by lastUsedAt DESC
 */
const getRecentDestinations = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const destinations = yield recentDestination_model_1.RecentDestination.find({ userId })
        .sort({ lastUsedAt: -1 })
 ...
 */
const deleteRecentDestination = (userId, destinationId) => __awaiter(void 0, void 0, void 0, function* () {
    const destination = yield recentDestination_model_1.RecentDestination.findOne({
        _id: destinationId,
        userId,
    });
    if (!destination) {
    ...
    yield recentDestination_model_1.RecentDestination.deleteOne({ _id: destinationId, userId });
});
/**
 * Clear all recent destinations for a user
 */
const clearAllRecentDestinations = (userId) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const saveOrUpdateRecentDestination = (userId, address, placeName, coordinates) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (coordinates) {
        ...
        existingDestination = yield recentDestination_model_1.RecentDestination.findOne({
            userId,
            location: {
                $nearSphere: {
                    $geometry: {
    ...
    const newDestination = yield recentDestination_model_1.RecentDestination.create({
 ...
 */
const enforceDestinationLimit = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const count = yield recentDestination_model_1.RecentDestination.countDocuments({ userId });
    if (count > MAX_RECENT_DESTINATIONS) {
        // Find and delete the oldest destinations
        const destinationsToDelete = yield recentDestination_model_1.RecentDestination.find({ userId })
            .sort({ lastUsedAt: 1 })
