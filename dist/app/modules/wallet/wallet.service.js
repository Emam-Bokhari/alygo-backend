 ...
 */
const getOrCreateWallet = (userId, session) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const getWalletHistory = (userId_1, role_1, ...args_1) => __awaiter(void 0, [userId_1, role_1, ...args_1], void 0, function* (userId, role, filter = "all") {
    yield getOrCreateWallet(userId);
    return yield transaction_service_1.TransactionService.getTransactionsByUser(userId, role, filter);
});
/**
 ...
 */
const topUpWallet = (userId, amount) => __awaiter(void 0, void 0, void 0, function* () {
    if (amount <= 0) {
        throw new ApiErrors_1.default(400, "Top-up amount must be greater than zero.");
    }
