...
const createServiceAreaToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const serviceArea = yield serviceArea_model_1.ServiceArea.create(payload);
    return serviceArea;
});
const getServiceAreaFromDB = (serviceAreaId) => __awaiter(void 0, void 0, void 0, function* () {
    const serviceArea = yield serviceArea_model_1.ServiceArea.findById(serviceAreaId);
    if (!serviceArea) {
        throw new ApiErrors_1.default(404, "Service area not found");
    }
    return serviceArea;
});
const getAllServiceAreasFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const serviceAreaQuery = new queryBuilder_1.default(serviceArea_model_1.ServiceArea.find(), query)
...
const getCountriesFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const countriesQuery = new queryBuilder_1.default(serviceArea_model_1.ServiceArea.find({ type: "country" }), query)
        .filter()
        .sort()
        .paginate()
        .fields();
...
const getStatesByCountryFromDB = (countryId, query) => __awaiter(void 0, void 0, void 0, function* () {
    const statesQuery = new queryBuilder_1.default(serviceArea_model_1.ServiceArea.find({
        type: "state",
...
const getStatesFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const statesQuery = new queryBuilder_1.default(serviceArea_model_1.ServiceArea.find({ type: "state" }), query)
        .filter()
        .sort()
        .paginate()
        .fields();
...
const getCitiesByStateFromDB = (stateId, query) => __awaiter(void 0, void 0, void 0, function* () {
    const citiesQuery = new queryBuilder_1.default(serviceArea_model_1.ServiceArea.find({
        type: "city",
...
const getZonesByCityFromDB = (cityId, query) => __awaiter(void 0, void 0, void 0, function* () {
    const zonesQuery = new queryBuilder_1.default(serviceArea_model_1.ServiceArea.find({
        type: "zone",
...
const getAirportsByCityFromDB = (cityId, query) => __awaiter(void 0, void 0, void 0, function* () {
    const airportsQuery = new queryBuilder_1.default(serviceArea_model_1.ServiceArea.find({
        type: "airport",
        cityId: new mongoose_1.Types.ObjectId(cityId),
    }), query)
        .filter()
...
const updateServiceAreaFromDB = (serviceAreaId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedServiceArea = yield serviceArea_model_1.ServiceArea.findByIdAndUpdate(serviceAreaId, payload, { new: true, runValidators: true });
    if (!updatedServiceArea) {
        throw new ApiErrors_1.default(404, "Service area not found");
    }
    return updatedServiceArea;
});
const deleteServiceAreaFromDB = (serviceAreaId) => __awaiter(void 0, void 0, void 0, function* () {
    const deletedServiceArea = yield serviceArea_model_1.ServiceArea.softDeleteById(serviceAreaId);
 ...
 */
const findServiceAreaByCoordinates = (longitude, latitude) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (serviceAreas.length > 0) {
        try {
            const validServiceAreas = serviceAreas.filter((sa) => sa.location && sa.location.coordinates);
            if (validServiceAreas.length > 0) {
                ...
                for (let i = 0; i < validServiceAreas.length; i++) {
                    ...
                    const result = (_a = matrix[0]) === null || _a === void 0 ? void 0 : _a[i];
                    if (result &&
                        result.status === "OK" &&
            ...
            logger_1.logger.error(`[ServiceAreaService] Error checking service area coverage via Google: ${err}`);
            throw err;
        }
    }
 ...
 */
const findAllServiceAreasByCoordinates = (longitude, latitude) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const serviceAreas = yield serviceArea_model_1.ServiceArea.find({
        location: {
            $nearSphere: {
 ...
 */
const isPointInServiceArea = (serviceAreaId, longitude, latitude) => __awaiter(void 0, void 0, void 0, function* () {
    const serviceArea = yield serviceArea_model_1.ServiceArea.findById(serviceAreaId);
    if (!serviceArea || !serviceArea.location || !serviceArea.coverageRadiusKm) {
        return false;
    }
    try {
        const distance = yield googleRouteService_1.GoogleRouteService.getRoadDistance({ lat: latitude, lng: longitude }, {
        ...
        logger_1.logger.error(`[ServiceAreaService] Error checking point inside service area coverage: ${err}`);
        throw err;
    }
});
