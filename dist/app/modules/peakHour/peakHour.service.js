...
const createPeakHourToDB = (payload) =>
...
const getPeakHourFromDB = (peakHourId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAllPeakHourFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield peakHour_model_1.PeakHour.find({});
  });
const getActivePeakHourFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield peakHour_model_1.PeakHour.find({
      status: status_1.STATUS.ACTIVE,
    });
  });
const updatePeakHourToDB = (peakHourId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(peakHourId)) {
      throw new ApiErrors_1.default(
        http_status_codes_1.StatusCodes.NOT_ACCEPTABLE,
    ...
    const isPeakHourExist =
      yield peakHour_model_1.PeakHour.findById(peakHourId);
    if (!isPeakHourExist) {
      throw new ApiErrors_1.default(404, "Peak hour not found");
    }
    const peakHour = yield peakHour_model_1.PeakHour.findByIdAndUpdate(
      peakHourId,
      payload,
      {
        new: true,
...
const updatePeakHourStatusToDB = (peakHourId, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const peakHour = yield peakHour_model_1.PeakHour.findById(peakHourId);
    if (!peakHour) {
      throw new ApiErrors_1.default(404, "Peak hour not found");
    }
    const result = yield peakHour_model_1.PeakHour.findByIdAndUpdate(
      peakHourId,
      { status },
      { new: true },
    );
...
const deletePeakHourToDB = (peakHourId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isPeakHourExist =
      yield peakHour_model_1.PeakHour.findById(peakHourId);
    if (!isPeakHourExist) {
