 ...
 */
const createReviewInDB = (reviewerId, reviewerRole, rideId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (receiverRole === "user") {
        const user =
          yield user_model_1.User.findById(receiverId).session(session);
        if (user) {
 ...
 */
const getDriverReviewsFromDB = (driverId) =>
  __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const getUserReviewsFromDB = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const getDriverReviewSummaryFromDB = (driverId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let driver = yield driver_model_1.Driver.findById(driverId);
    if (!driver) {
      driver = yield driver_model_1.Driver.findOne({
