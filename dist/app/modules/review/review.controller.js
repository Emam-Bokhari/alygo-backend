...
const createReview = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { review, pendingPayment, paymentResult } =
      yield review_service_1.ReviewServices.createReviewInDB(
        reviewerId,
        reviewerRole,
        rideId,
        req.body,
    ...
    if (paymentResult) {
      if (paymentResult.method === "stripe") {
        ...
        return (0, sendResponse_1.default)(res, {
          ...
          success: true,
          message:
            "Review submitted successfully. Payment completed via wallet.",
          data: {
            review,
            payment: {
              required: true,
 ...
 */
const getDriverReviews = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { driverId } = req.params;
    const result =
      yield review_service_1.ReviewServices.getDriverReviewsFromDB(driverId);
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_codes_1.StatusCodes.OK,
      success: true,
 ...
 */
const getUserReviews = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { userId } = req.params;
    const result =
      yield review_service_1.ReviewServices.getUserReviewsFromDB(userId);
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_codes_1.StatusCodes.OK,
      success: true,
 ...
 */
const getDriverReviewSummary = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { driverId } = req.params;
    const result =
      yield review_service_1.ReviewServices.getDriverReviewSummaryFromDB(
        driverId,
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_codes_1.StatusCodes.OK,
