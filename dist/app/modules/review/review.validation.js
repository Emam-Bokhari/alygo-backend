...
const passengerReviewValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        reviewText: zod_1.z
            ...
            message: "Review text cannot be empty and must be under 500 characters",
        }),
        selectedTags: zod_1.z.nativeEnum(review_constant_1.PASSENGER_REVIEW_TAG).optional(),
        appreciation: zod_1.z
            ...
            // Custom
            const min = 1;
            const max = ((_a = config_1.default.payment) === null || _a === void 0 ? void 0 : _a.maxDriverAppreciation) || 100;
...
const driverReviewValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        selectedTags: zod_1.z.nativeEnum(review_constant_1.DRIVER_REVIEW_TAG).optional(),
    }),
});
