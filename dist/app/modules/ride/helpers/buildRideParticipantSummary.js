...
exports.buildDriverSocketPayload = exports.buildPassengerSocketPayload = exports.buildPassengerSummary = exports.buildDriverSummary = void 0;
 ...
 */
const buildDriverSummary = (driver, car) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    if (driver.userId && typeof driver.userId === "object") {
        ...
        // Need to fetch user
        driverUser = yield user_model_1.User.findById(driver.userId).select("name profileImage");
    }
    ...
    return {
        _id: ((_a = driverUser === null || driverUser === void 0 ? void 0 : driverUser._id) === null || _a === void 0 ? void 0 : _a.toString()) || ((_b = driver.userId) === null || _b === void 0 ? void 0 : _b.toString()) || "",
        name: (driverUser === null || driverUser === void 0 ? void 0 : driverUser.name) || "",
        profileImage: driverUser === null || driverUser === void 0 ? void 0 : driverUser.profileImage,
 ...
 */
const buildPassengerSocketPayload = (ride, driverSummary) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const buildDriverSocketPayload = (ride, passengerSummary) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const buildDriverSummaryForRide = (ride) => __awaiter(void 0, void 0, void 0, function* () {
    if (!ride.driverId) {
        throw new Error("Driver ID not found in ride");
    }
    const driver = yield driver_model_1.Driver.findOne({ userId: ride.driverId });
    if (!driver) {
 ...
 */
const buildPassengerSummaryForRide = (ride) => __awaiter(void 0, void 0, void 0, function* () {
    let user;
    if (ride.userId && typeof ride.userId === "object") {
        ...
        user = yield user_model_1.User.findById(ride.userId).select("name profileImage averageRating totalRatings");
    }
    if (!user) {
