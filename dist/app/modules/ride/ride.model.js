  ...
  },
  {
    ...
    toJSON: {
      ...
      transform: (_doc, ret) => {
        ...
        if (
          (_a = ret.pickupVerification) === null || _a === void 0
            ? void 0
            : _a.phoneLastFourDigits
        ) {
          delete ret.pickupVerification.phoneLastFourDigits.value;
        }
        if (
          (_b = ret.dropVerification) === null || _b === void 0
            ? void 0
            : _b.phoneLastFourDigits
        ) {
        ...
        if (
          (_d =
            (_c = ret.pickupVerification) === null || _c === void 0
              ? void 0
              : _c.otp) === null || _d === void 0
            ? void 0
            : _d.code
        ) {
        ...
        if (
          (_f =
            (_e = ret.dropVerification) === null || _e === void 0
              ? void 0
              : _e.otp) === null || _f === void 0
            ? void 0
            : _f.code
        ) {
...
rideSchema.virtual("timeRemainingToPickup").get(function () {
  if (
    this.rideType !== ride_constant_1.RIDE_TYPE.SCHEDULED ||
    !this.scheduledAt
  ) {
    return null;
  }
