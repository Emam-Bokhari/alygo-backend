...
const calculateFare = (
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const rideCategory =
      yield rideCategory_model_1.RideCategory.findById(categoryId);
    if (!rideCategory) {
    ...
    if (serviceAreaId) {
      try {
        multiplier =
          yield surgeCalculation_service_1.SurgeCalculationService.calculateSurgeMultiplier(
            serviceAreaId.toString(),
          );
      } catch (err) {
        logger_1.logger.error(
          `Error calculating surge multiplier: ${err.message}`,
        );
      }
    }
    ...
    return {
      ...
      stopWaitingCharge: parseFloat(
        (stopWaitingCharge * multiplier).toFixed(2),
      ),
      cancellationFee: 0,
      discount: 0,
 ...
 */
const estimateFareAndRoute = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const {
      pickup,
    ...
    if (scheduledAt && timezone) {
      scheduledAtUtc = (0, timezoneHelper_1.timezoneToUtc)(
        scheduledAt,
        timezone,
      ).toJSDate();
    }
    ...
    if (serviceCategoryId || isReservation) {
      ...
      if (serviceCategoryId) {
        ...
        if (serviceCategoryDoc.status !== status_1.STATUS.ACTIVE) {
          throw new ApiErrors_1.default(
            400,
            "Service Category is disabled or inactive",
          );
        }
    ...
    const stopsCoords = stops
      ...
      : [];
    const routeInfo = yield googleMapsHelper_1.googleMapsHelper.getRoute(
      originCoord,
      destCoord,
      stopsCoords,
    );
    ...
    let serviceAreaId =
      serviceArea === null || serviceArea === void 0 ? void 0 : serviceArea._id;
    ...
    if (!serviceArea) {
      ...
      const geoDetails =
        yield googleMapsHelper_1.googleMapsHelper.reverseGeocode(
          latitude,
          longitude,
        );
    ...
    for (const cat of categories) {
      try {
        ...
        categoryEstimations.push({
          ...
          vehicleType:
            ((_a = cat.vehicleRequirements) === null || _a === void 0
              ? void 0
              : _a.vehicleTypes) || [],
          vehicleCapacity:
            ((_b = cat.vehicleRequirements) === null || _b === void 0
              ? void 0
              : _b.minimumSeats) || 0,
          luggageCapacity:
            ((_c = cat.vehicleRequirements) === null || _c === void 0
              ? void 0
              : _c.luggageCapacity) || 0,
    ...
    return {
      ...
      serviceCategory: serviceCategoryDoc
        ? {
            ...
            supportsReservation:
              serviceCategoryDoc.supportsReservation !== false,
          }
        : null,
      routeInfo,
      estimatedDistance: routeInfo.totalDistanceKm,
 ...
 */
const requestRide = (userId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isReservation =
      payload.rideType === ride_constant_1.RIDE_TYPE.SCHEDULED;
    if (isReservation) {
      ...
      if (
        !mongoose_2.default.Types.ObjectId.isValid(payload.serviceCategoryId)
      ) {
        throw new ApiErrors_1.default(400, "Invalid Service Category ID");
      }
      ...
      const minAdvanceMinutes =
        (_a = serviceCategory.minimumAdvanceBookingMinutes) !== null &&
        _a !== void 0
          ? _a
          : systemConfig.reservation.minAdvanceMinutes;
      const maxAdvanceDays =
        (_b = serviceCategory.maximumAdvanceBookingDays) !== null &&
        _b !== void 0
          ? _b
    ...
    const category = yield rideCategory_model_1.RideCategory.findById(
      payload.rideCategoryId,
    );
    if (!category) {
    ...
    if (category.status !== status_1.STATUS.ACTIVE) {
      throw new ApiErrors_1.default(
        400,
        "Selected ride category is disabled or inactive",
      );
    }
    ...
    const eligibleDrivers = yield (0,
    driverMatchingService_1.findEligibleDriversInRadius)({
      ...
      rideServiceAreaId:
        (_d =
          (_c = routeEstimation.serviceArea) === null || _c === void 0
            ? void 0
    ...
    const baseCalculatedFare = selectedCategoryEstimation
      ? {
          ...
          distanceFare:
            selectedCategoryEstimation.pricingBreakdown.distanceFare,
      ...
      : yield calculateFare(
          ...
          (_e = routeEstimation.serviceArea) === null || _e === void 0
            ? void 0
            : _e._id,
          payload.serviceCategoryId,
        );
    const fareSnapshot = Object.assign(Object.assign({}, baseCalculatedFare), {
    ...
    const ridePayload = {
      ...
      serviceAreaId:
        (_f = routeEstimation.serviceArea) === null || _f === void 0
          ? void 0
          : _f._id,
      serviceCategoryId: payload.serviceCategoryId
      ...
      stops:
        (_g = payload.stops) === null || _g === void 0
          ? void 0
          : _g.map((s) => ({
              order: s.order,
              address: s.address,
    ...
    const driverSearchTiming = (0,
    rideSearchTimingHelper_1.calculateDriverSearchTiming)(ride);
    ...
    const passengerSummary = (0,
    buildRideParticipantSummary_1.buildPassengerSummary)(user);
    ...
    selectedDrivers.forEach((driver) => {
      ...
      const sent = socketHelper_1.socketHelper.sendToUser(
    ...
    yield bullmq_1.rideExpirationQueue.add(
    ...
    selectedDrivers.forEach((driver) => {
      bullmq_1.driverVisibilityQueue.add(
    ...
    if (selectedDrivers.length === 0) {
      yield bullmq_1.radiusExpansionQueue.add(
 ...
 */
const acceptRide = (driverUserId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      rideToAccept.rideType === ride_constant_1.RIDE_TYPE.SCHEDULED &&
    ...
    try {
      ...
      const updateFields = {
        ...
        "driverMatching.notifiedDrivers.$[elem].status":
          ride_constant_1.DRIVER_MATCHING_STATUS.ACCEPTED,
      ...
      // Atomic update on Ride ensuring status is searching and driverId is empty
      const ride = yield ride_model_1.Ride.findOneAndUpdate(
        ...
        },
        {
          new: true,
          session,
          arrayFilters: [{ "elem.driverId": userObjectId }],
        },
      );
      if (!ride) {
        throw new ApiErrors_1.default(
      ...
      // Set driver availability status to ON_TRIP
      ...
      if (driverDoc.location && driverDoc.location.coordinates) {
        try {
          const route =
            yield googleRouteService_1.GoogleRouteService.calculateRoute(
              {
      ...
      yield tracking_model_1.Tracking.findOneAndUpdate(
        { rideId: ride._id },
        {
          $set: {
            driverId: userObjectId,
      ...
      yield driverDutyPolicy_service_1.DriverDutyPolicyServices.updateDriverAvailability(
        userObjectId.toString(),
      );
      // Cancel all BullMQ jobs for this ride since it's been accepted
      try {
        // Remove ride expiration job
        const expirationJob = yield bullmq_1.rideExpirationQueue.getJob(
          `ride-expiration-${ride._id}`,
        );
        if (expirationJob) yield expirationJob.remove();
        // Remove all driver visibility jobs for this ride
        const visibilityJobs = yield bullmq_1.driverVisibilityQueue.getJobs(
          ["waiting", "delayed"],
          0,
          100,
        );
        ...
        const expansionJobs = yield bullmq_1.radiusExpansionQueue.getJobs(
          ["waiting", "delayed"],
          0,
          100,
        );
        ...
        logger_1.logger.info(
          `Cancelled all BullMQ jobs for accepted ride ${ride._id}`,
        );
      } catch (error) {
        logger_1.logger.error(
          `Error cancelling BullMQ jobs for ride ${ride._id}:`,
          error,
        );
      }
      ...
      const driverSummary = yield (0,
      buildRideParticipantSummary_1.buildDriverSummary)(driverDoc, car);
      // Real-time socket events:
      // A. Notify Passenger that ride is accepted
      const driverSearchTiming = (0,
      rideSearchTimingHelper_1.calculateDriverSearchTiming)(ride);
      // Get tracking info for ETA
      const tracking = yield tracking_model_1.Tracking.findOne({
        rideId: ride._id,
      });
      socketHelper_1.socketHelper.sendToUser(
      ...
      socketHelper_1.socketHelper.sendToUsers(
        otherDrivers,
 ...
 */
const rejectRide = (driverUserId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const driverDoc = yield driver_model_1.Driver.findOne({
      userId: driverUserId,
    }).populate("userId", "name profileImage");
    ...
    if (!ride) {
      throw new ApiErrors_1.default(
        404,
        "Ride not found or no longer accepting drivers.",
      );
    }
    ...
    if (!driverNotification) {
      throw new ApiErrors_1.default(
        400,
        "You were not notified for this ride request.",
      );
    }
    if (
      driverNotification.status !== ride_constant_1.DRIVER_MATCHING_STATUS.SENT
    ) {
      throw new ApiErrors_1.default(
        400,
        "You have already responded to this ride request.",
      );
    }
    ...
    const allDriversResponded = ride.driverMatching.notifiedDrivers.every(
      (d) => d.status !== ride_constant_1.DRIVER_MATCHING_STATUS.SENT,
    );
 ...
 */
const triggerImmediateRadiusExpansion = (ride) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const existingJobs = yield bullmq_1.radiusExpansionQueue.getJobs(
        ["waiting", "delayed"],
        0,
        100,
      );
      ...
      logger_1.logger.error(
        `Error cancelling existing radius expansion jobs:`,
        error,
      );
    }
 ...
 */
const arriveAtPickup = (driverUserId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const ride = yield ride_model_1.Ride.findOne({
      _id: rideId,
    ...
    if (
      ride.status !== ride_constant_1.RIDE_STATUS.DRIVER_ACCEPTED &&
      ride.status !== ride_constant_1.RIDE_STATUS.DRIVER_ON_THE_WAY
    ) {
      throw new ApiErrors_1.default(
        400,
        "Invalid ride status transition to Arrived.",
      );
    }
    ...
    const car = yield car_model_1.Car.findOne({
      driverId:
        driverDoc === null || driverDoc === void 0 ? void 0 : driverDoc._id,
      isVerified: true,
    });
    const driverSummary = yield (0,
    buildRideParticipantSummary_1.buildDriverSummary)(driverDoc, car);
 ...
 */
const requestStartVerification = (driverUserId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const ride = yield ride_model_1.Ride.findOne({
      _id: rideId,
      driverId: driverUserId,
 ...
 */
const startRide = (driverUserId, rideId, verification, ipAddress) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const ride = yield ride_model_1.Ride.findOne({
      _id: rideId,
    ...
    if (
      ((_a = ride.pickupVerification.otp) === null || _a === void 0
        ? void 0
        : _a.verified) ||
      ((_b = ride.pickupVerification.phoneLastFourDigits) === null ||
      _b === void 0
        ? void 0
        : _b.verified)
    ) {
      throw new ApiErrors_1.default(
        400,
        "Ride has already been verified and started.",
      );
    }
    ...
    if (otp) {
      ...
      if (savedPhone && savedPhone.value === phoneLastFourDigits) {
        ...
        throw new ApiErrors_1.default(
          400,
          "Incorrect phone number digits verification.",
        );
      }
    }
    if (!verified) {
    ...
    const driverSummary = yield (0,
    buildRideParticipantSummary_1.buildDriverSummary)(driverDoc, car);
    const userDoc = yield user_model_1.User.findById(ride.userId).select(
      "name profileImage averageRating totalRatings",
    );
    const passengerSummary = (0,
    buildRideParticipantSummary_1.buildPassengerSummary)(userDoc);
    ...
    socketHelper_1.socketHelper.sendToUser(driverUserId, "ride-started", {
      rideId: ride._id,
      user: passengerSummary,
    });
    yield (0, notificationsHelper_1.sendNotifications)({
 ...
 */
const requestEndVerification = (driverUserId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const ride = yield ride_model_1.Ride.findOne({
      _id: rideId,
      driverId: driverUserId,
 ...
 */
const completeRide = (driverUserId, rideId, verification, ipAddress) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const ride = yield ride_model_1.Ride.findOne({
      _id: rideId,
    ...
    // Prevent duplicate verification
    if (
      ((_a = ride.dropVerification.otp) === null || _a === void 0
        ? void 0
        : _a.verified) ||
      ((_b = ride.dropVerification.phoneLastFourDigits) === null ||
      _b === void 0
        ? void 0
        : _b.verified)
    ) {
      throw new ApiErrors_1.default(
        400,
        "Ride has already been verified and completed.",
      );
    }
    const { otp, phoneLastFourDigits } = verification;
    let verified = false;
    ...
    if (otp) {
      ...
      if (savedPhone && savedPhone.value === phoneLastFourDigits) {
        ...
        throw new ApiErrors_1.default(
          400,
          "Incorrect passenger phone verification digits.",
        );
      }
    }
    if (!verified) {
      throw new ApiErrors_1.default(
        400,
        "Ride end completion verification failed.",
      );
    }
    // Log successful verification attempt
    ride.dropVerification.verificationAttempts =
    ...
    try {
      ...
      recentDestination_service_1.RecentDestinationServices.saveOrUpdateRecentDestination(
        ride.userId.toString(),
      ...
      socketHelper_1.socketHelper.sendToUser(driverUserId, "ride-completed", {
        rideId: ride._id,
        user: passengerSummary,
      });
      yield (0, notificationsHelper_1.sendNotifications)({
 ...
 */
const completeRidePayment = (
  rideId,
  paymentMethod,
  paymentIntent, // optional Stripe PaymentIntent object (if paid via Stripe)
    ...
    try {
      ...
      if (useWallet && walletAmount > 0) {
        const passengerWallet =
          yield wallet_service_1.WalletService.getOrCreateWallet(
            ride.userId,
            session,
          );
      ...
      yield ride.save({ session });
      if (
        ((_a = ride.fare) === null || _a === void 0
          ? void 0
          : _a.pendingCancellationFee) &&
        ride.fare.pendingCancellationFee > 0
      ) {
        yield pendingPayment_model_1.PendingPayment.updateMany(
          ...
          [
            {
              ...
              userId: ride.driverId,
              driverId:
                (driverProfile === null || driverProfile === void 0
                  ? void 0
                  : driverProfile._id) || undefined,
              bookingId: ride._id,
              rideId: ride._id,
      ...
      if (ride.driverId) {
        const driverReceipt = Object.assign(Object.assign({}, receipt), {
          user: passengerSummary,
        });
        socketHelper_1.socketHelper.sendToUser(
          ride.driverId.toString(),
 ...
 */
const confirmCashPayment = (driverUserId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const ride = yield ride_model_1.Ride.findOne({
      _id: rideId,
 ...
 * Cancel ride
 */
const cancelRide = (userId, role, rideId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      ...
      throw new ApiErrors_1.default(
        400,
        "Cannot cancel ride in its current state.",
      );
    }
    const isUserPassenger = ride.userId.toString() === userId;
    const isUserDriver =
      ((_a = ride.driverId) === null || _a === void 0
        ? void 0
        : _a.toString()) === userId;
    // Check if user is a notified driver (for rides in SEARCHING_DRIVER status)
    const isNotifiedDriver =
      ((_c =
        (_b = ride.driverMatching) === null || _b === void 0
          ? void 0
          : _b.notifiedDrivers) === null || _c === void 0
        ? void 0
        : _c.some((d) => d.driverId.toString() === userId)) || false;
    if (
      !isUserPassenger &&
      !isUserDriver &&
      !isNotifiedDriver &&
    ...
    const policyConfig =
      yield cancellationPolicy_service_1.CancellationPolicyService.getPolicyConfig();
    ...
    if (
      ...
      const mapped = cancellationPolicy_service_1.CANCEL_SCENARIO_MAPPING[
        scenarioName
      ] || {
      ...
      const surgeMultiplier =
        ((_d = ride.fare) === null || _d === void 0
          ? void 0
          : _d.surgeMultiplier) || 1.0;
      ...
      try {
        ...
        ride.cancellation = {
          ...
          surgeSnapshot: {
            multiplier:
              ((_e = ride.fare) === null || _e === void 0
                ? void 0
                : _e.surgeMultiplier) || 1.0,
            amount:
              ((_f = ride.fare) === null || _f === void 0
                ? void 0
                : _f.surgeApplied) || 0.0,
          },
        ...
        if (cancellationFee > 0) {
          const [createdPendingPayment] =
            yield pendingPayment_model_1.PendingPayment.create(
              [
                {
                  userId: ride.userId,
                  rideId: ride._id,
        ...
        try {
          ...
          logger_1.logger.error(
            "Error clearing match queues on cancellation:",
            err,
          );
        }
        // Build enriched summaries for both passenger and driver
        ...
        if (ride.driverId) {
          ...
          const car = yield car_model_1.Car.findOne({
            driverId:
              driverDoc === null || driverDoc === void 0
                ? void 0
                : driverDoc._id,
            isVerified: true,
          });
        ...
        if (ride.rideType === ride_constant_1.RIDE_TYPE.SCHEDULED) {
          ...
          if (ride.driverId) {
            socketHelper_1.socketHelper.sendToUser(
              ride.driverId.toString(),
              "reservation-cancelled",
              Object.assign(Object.assign({}, cancelPayload), {
                user: passengerSummary,
              }),
            );
          }
        ...
        (_h =
          (_g = ride.driverMatching) === null || _g === void 0
            ? void 0
            : _g.notifiedDrivers) === null || _h === void 0
          ? void 0
          : _h.forEach((d) => {
      ...
      try {
          ...
          { userId: cancellingDriverUserId },
          {
            ...
            $push: {
              cancellationHistory: {
                ...
                cancellationReasonId: cancellationReason._id,
                cancellationReasonName:
                  payload.cancellationReasonName ||
        ...
        if (driverNotification) {
          driverNotification.status =
            ride_constant_1.DRIVER_MATCHING_STATUS.REJECTED;
          driverNotification.respondedAt = new Date();
        } else {
        ...
        if (remainingMs <= 0) {
          ...
          socketHelper_1.socketHelper.sendToUser(
            ...
            "ride-expired",
            {
              rideId: ride._id,
              message:
                "Request expired. No driver found within the time limit.",
              driverSearch: (0,
              rideSearchTimingHelper_1.calculateDriverSearchTiming)(ride),
            },
          );
          ...
          try {
            const expJob = yield bullmq_1.rideExpirationQueue.getJob(
              `ride-expiration-${ride._id}`,
            );
            if (expJob) yield expJob.remove();
          } catch (e) {}
          yield bullmq_1.rideExpirationQueue.add(
            `ride-expiration-${ride._id}`,
            {
          ...
          driverMatchingService_1.findEligibleDriversInRadius)({
            ...
            rideCategoryId: ride.rideCategory.categoryId.toString(),
            serviceCategoryId:
              (_k = ride.serviceCategoryId) === null || _k === void 0
                ? void 0
                : _k.toString(),
            ...
            rideServiceAreaId:
              (_l = ride.serviceAreaId) === null || _l === void 0
                ? void 0
                : _l.toString(),
          });
          ...
          if (newDrivers.length > 0) {
            ...
            const userDoc = yield user_model_1.User.findById(
              ride.userId,
            ).select("name profileImage averageRating totalRatings");
            const passengerSummary = (0,
            buildRideParticipantSummary_1.buildPassengerSummary)(userDoc);
                ...
                },
                {
                  delay:
                    systemConfig.driverMatching
                      .driverVisibilityDurationSeconds * 1000,
                  jobId: `driver-visibility-${ride._id}-${driver.driverId}`,
                },
              );
            });
 ...
 */
const addStopsDuringTrip = (userId, rideId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    const ride = yield ride_model_1.Ride.findById(rideId);
    if (!ride) {
    ...
    if (ride.userId.toString() !== userId) {
      throw new ApiErrors_1.default(
        403,
        "Only the passenger can add stops to this ride",
      );
    }
    ...
    const currentStopOrder =
      (_a =
        tracking === null || tracking === void 0
          ? void 0
          : tracking.currentStopOrder) !== null && _a !== void 0
        ? _a
        : -1;
    ...
    for (const newStop of payload.stops) {
      ...
      const existingStop =
        (_b = ride.stops) === null || _b === void 0
          ? void 0
          : _b.find((s) => s.order === newStop.order);
      if (existingStop) {
        throw new ApiErrors_1.default(
          400,
    ...
    console.log(
      "  Uncompleted Existing Stops:",
      uncompletedExistingStops.length,
    );
    ...
    const newRouteInfo = yield googleMapsHelper_1.googleMapsHelper.getRoute(
      originCoord,
      destCoord,
      waypoints,
    );
    // Calculate remaining fare based on new route
    const remainingFare = yield calculateFare(
 ...
 */
const getRideDetails = (userId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
 ...
 */
const getActiveRide = (userId, role) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const activeStates = [
      ride_constant_1.RIDE_STATUS.SEARCHING_DRIVER,
      ride_constant_1.RIDE_STATUS.DRIVER_ACCEPTED,
    ...
    let query = { status: { $in: activeStates } };
    if (role === "driver") {
      query.driverId = new mongoose_1.Types.ObjectId(userId);
    } else {
...
const getDriverRideHistory = (driverUserId, query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (query.rideType) {
      if (
        query.rideType === ride_constant_1.RIDE_TYPE.INSTANT ||
    ...
    if (query.status) {
      ...
      if (rawStatus === "cancelled") {
        ...
        Object.values(ride_constant_1.RIDE_STATUS).includes(rawStatus)
      ) {
    ...
    const data = rides.map((ride) => {
      ...
      return {
        ...
        payment: {
          method:
            (_a = ride.payment) === null || _a === void 0 ? void 0 : _a.method,
          status:
            (_b = ride.payment) === null || _b === void 0 ? void 0 : _b.status,
          paidAt:
            (_c = ride.payment) === null || _c === void 0 ? void 0 : _c.paidAt,
        },
        ...
        cancelledAt:
          (_d = ride.cancellation) === null || _d === void 0
            ? void 0
            : _d.cancelledAt,
