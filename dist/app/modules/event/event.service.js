...
const updateEventToDB = (eventId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const event = yield event_model_1.Event.findByIdAndUpdate(
      eventId,
      payload,
      {
        new: true,
...
const updateEventStatusToDB = (eventId, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const event = yield event_model_1.Event.findById(eventId);
    if (!event) {
      throw new ApiErrors_1.default(404, "Event not found");
    }
    const result = yield event_model_1.Event.findByIdAndUpdate(
      eventId,
      { status },
      { new: true },
    );
