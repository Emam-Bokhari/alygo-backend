...
const getActiveEvent = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateEvent = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield event_service_1.EventService.updateEventToDB(eventId, updateData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
const updateEventStatus = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { eventId } = req.params;
    const { status } = req.body;
    const result = yield event_service_1.EventService.updateEventStatusToDB(eventId, status);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
