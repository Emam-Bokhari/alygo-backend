...
const getCarByDriver = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user) {
        throw new ApiErrors_1.default(401, "User not authenticated");
    }
    const { id } = req.user;
...
const updateCar = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { carId } = req.params;
    const result = yield car_service_1.CarServices.updateCarFromDB(carId, req.body);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
