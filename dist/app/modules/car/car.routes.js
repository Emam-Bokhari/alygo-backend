...
router
    .route("/")
    .post(authHelper_1.isDriver, (0, flieUploadHandler_1.default)(), (0, parseFileData_1.parseFileData)({
...
router
    ...
    .patch(authHelper_1.isDriver, (0, flieUploadHandler_1.default)(), (0, parseFileData_1.parseFileData)({
    fieldName: "vehicleLicense",
    mode: "single",
}, {
    fieldName: "personalAutoInsurance",
