...
const createCarToDB = (userId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const carPayload = Object.assign(
      { driverId: new mongoose_1.Types.ObjectId(driverId._id) },
      payload,
    );
    const car = yield car_model_1.Car.create(carPayload);
    return car;
  });
const getCarFromDB = (carId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getCarByDriverFromDB = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const driverId = yield driver_model_1.Driver.findOne({ userId });
    if (!driverId) {
      throw new ApiErrors_1.default(404, "Driver not found");
...
const updateCarFromDB = (carId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const _a = payload,
      { driverId } = _a,
      updatePayload = __rest(_a, ["driverId"]);
    const updatedCar = yield car_model_1.Car.findByIdAndUpdate(
      carId,
      updatePayload,
      {
        new: true,
