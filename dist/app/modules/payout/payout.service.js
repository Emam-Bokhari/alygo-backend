 ...
 */
const requestWithdrawal = (driverUserId, amount) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const stripeAccount = yield stripe_1.default.accounts.retrieve(
    ...
    const wallet =
      yield wallet_service_1.WalletService.getOrCreateWallet(driverUserId);
 ...
 */
const getWithdrawalHistory = (driverUserId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield payout_model_1.Payout.find({
      userId: new mongoose_1.Types.ObjectId(driverUserId),
    })
      .sort({ createdAt: -1 })
