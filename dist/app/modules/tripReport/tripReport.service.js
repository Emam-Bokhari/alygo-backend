 ...
 */
const createTripReport = (reporterId, rideId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const issueCategory =
      yield reportIssueCategory_model_1.ReportIssueCategory.findById(
        payload.issueId,
      );
    if (!issueCategory) {
      throw new ApiErrors_1.default(
    ...
    const reportData = {
      ...
      providedSummaryDetails:
        ((_a = payload.providedSummaryDetails) === null || _a === void 0
          ? void 0
          : _a.trim()) || "",
 ...
 * Admin only
 */
const getAllTripReports = (filters) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
      page = 1,
      limit = 10,
 ...
 * Admin only
 */
const getTripReportById = (reportId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const report = yield tripReport_model_1.TripReport.findById(reportId)
      ...
      .populate(
        "issueId",
        "issueName description estimatedResponseTimeInMinutes",
      )
      .populate("resolvedBy", "name email");
    if (!report) {
      throw new ApiErrors_1.default(
 ...
 * Admin only
 */
const updateTripReport = (adminId, reportId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const report = yield tripReport_model_1.TripReport.findById(reportId);
    if (!report) {
      throw new ApiErrors_1.default(
    ...
    if (payload.status) {
      ...
      if (
        payload.status === tripReport_constant_1.TRIP_REPORT_STATUS.RESOLVED &&
    ...
    const updatedReport = yield tripReport_model_1.TripReport.findByIdAndUpdate(
      reportId,
      updateData,
      { new: true },
    )
