...
router.get(
  ...
  tripReport_controller_1.TripReportController.getAllTripReports,
);
router.get(
  "/admin/trip-reports/:reportId",
  authHelper_1.isAdmin,
  tripReport_controller_1.TripReportController.getTripReportById,
);
router.patch(
  "/admin/trip-reports/:reportId",
  authHelper_1.isAdmin,
  tripReport_controller_1.TripReportController.updateTripReport,
);
