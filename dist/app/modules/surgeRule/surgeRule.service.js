...
// create surge rule
const createSurgeRule = (user, payload) =>
...
const getAllSurgeRules = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const surgeRuleQuery = new queryBuilder_1.default(
      surgeRule_model_1.SurgeRule.find(),
      query,
    )
      .search(["ruleName"])
      .filter()
...
const getActiveSurgeRules = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const surgeRuleQuery = new queryBuilder_1.default(
      surgeRule_model_1.SurgeRule.find({ status: status_1.STATUS.ACTIVE }),
      query,
    )
      .search(["ruleName"])
      .filter()
...
const getSurgeRuleById = (surgeRuleId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield surgeRule_model_1.SurgeRule.findById(surgeRuleId);
    return result;
  });
// update surge rule
const updateSurgeRule = (surgeRuleId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield surgeRule_model_1.SurgeRule.findByIdAndUpdate(
      surgeRuleId,
      { $set: payload },
      { new: true },
    );
...
const updateSurgeRuleStatus = (surgeRuleId, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Validate status
...
// delete surge rule
const deleteSurgeRule = (surgeRuleId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield surgeRule_model_1.SurgeRule.softDeleteById(surgeRuleId);
    return result;
  });
