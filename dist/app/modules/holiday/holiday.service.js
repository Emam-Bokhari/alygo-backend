...
const createHolidayToDB = (payload) =>
...
const getHolidayFromDB = (holidayId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAllHolidayFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield holiday_model_1.Holiday.find({});
  });
const getActiveHolidayFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield holiday_model_1.Holiday.find({
      status: status_1.STATUS.ACTIVE,
    });
  });
const updateHolidayToDB = (holidayId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(holidayId)) {
      throw new ApiErrors_1.default(
        http_status_codes_1.StatusCodes.NOT_ACCEPTABLE,
    ...
    const holiday = yield holiday_model_1.Holiday.findByIdAndUpdate(
      holidayId,
      payload,
      {
        new: true,
...
const updateHolidayStatusToDB = (holidayId, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield holiday_model_1.Holiday.findByIdAndUpdate(
      holidayId,
      { status },
      { new: true },
    );
...
const deleteHolidayToDB = (holidayId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isHolidayExist = yield holiday_model_1.Holiday.findById(holidayId);
    if (!isHolidayExist) {
      throw new ApiErrors_1.default(404, "Holiday not found");
