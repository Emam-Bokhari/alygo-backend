...
const createLostAndFoundItemCategoryToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const createLostAndFoundItemCategory =
      yield lostAndFoundItemCategory_model_1.LostAndFoundItemCategory.create(
        payload,
      );
...
const getLostAndFoundItemCategoryFromDB = (lostAndFoundItemCategoryId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (
      !mongoose_1.default.Types.ObjectId.isValid(lostAndFoundItemCategoryId)
    ) {
      throw new ApiErrors_1.default(
    ...
    const result =
      yield lostAndFoundItemCategory_model_1.LostAndFoundItemCategory.findById(
...
const getAllLostAndFoundItemCategoriesFromDB = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const searchableFields = ["name"];
    const lostAndFoundItemCategoryQuery = new queryBuilder_1.default(
      lostAndFoundItemCategory_model_1.LostAndFoundItemCategory.find(),
      query,
    )
...
const getActiveLostAndFoundItemCategoriesFromDB = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const searchableFields = ["name"];
    const lostAndFoundItemCategoryQuery = new queryBuilder_1.default(
      lostAndFoundItemCategory_model_1.LostAndFoundItemCategory.find({
...
const updateLostAndFoundItemCategoryToDB = (
  lostAndFoundItemCategoryId,
  payload,
) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lostAndFoundItemCategory =
      yield lostAndFoundItemCategory_model_1.LostAndFoundItemCategory.findByIdAndUpdate(
        lostAndFoundItemCategoryId,
        payload,
        {
          new: true,
...
const updateLostAndFoundItemCategoryStatusToDB = (
  lostAndFoundItemCategoryId,
  status,
) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteLostAndFoundItemCategoryToDB = (lostAndFoundItemCategoryId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (
      !mongoose_1.default.Types.ObjectId.isValid(lostAndFoundItemCategoryId)
    ) {
    ...
    const result =
      yield lostAndFoundItemCategory_model_1.LostAndFoundItemCategory.softDeleteById(
        lostAndFoundItemCategoryId,
      );
    return result;
  });
