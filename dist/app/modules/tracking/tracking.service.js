...
const getTrackingByRideId = (userId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!tracking) {
      throw new ApiErrors_1.default(
        404,
        "Tracking log not found for this ride yet.",
      );
    }
    return tracking;
  });
 ...
 * Optimized driver location update with validation and ETA calculation
 */
const updateDriverLocation = (driverUserId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    ...
    if (
      ...
      if (
        !driverDoc ||
        ((_b = ride.driverId) === null || _b === void 0
          ? void 0
          : _b.toString()) !== driverDoc.userId.toString()
      ) {
        throw new ApiErrors_1.default(
          403,
    ...
    let tracking = yield tracking_model_1.Tracking.findOne({
      ...
      oldLat:
        (_c =
          tracking === null || tracking === void 0
            ? void 0
            : tracking.driverLocation) === null || _c === void 0
          ? void 0
          : _c.coordinates[1],
      oldLon:
        (_d =
          tracking === null || tracking === void 0
            ? void 0
            : tracking.driverLocation) === null || _d === void 0
          ? void 0
          : _d.coordinates[0],
      lastUpdateTime:
        tracking === null || tracking === void 0
          ? void 0
          : tracking.lastDriverLocationUpdateAt,
    ...
    if (activeStatuses.includes(ride.status)) {
      try {
        ...
        const resolution =
          yield googleRouteService_1.GoogleRouteService.resolveCurrentTrackingState(
            {
    ...
    if (transitions.length > 0 && activeStatuses.includes(ride.status)) {
      try {
        const resolution =
          yield googleRouteService_1.GoogleRouteService.resolveCurrentTrackingState(
            {
    ...
    if (
      ...
      const driverUser =
        driverDoc === null || driverDoc === void 0 ? void 0 : driverDoc.userId;
      socketHelper_1.socketHelper.sendToUser(
        ride.userId.toString(),
 ...
 */
const processDriverLocationUpdate = (driverUserId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const [longitude, latitude] = payload.coordinates;
    const driverDoc = yield driver_model_1.Driver.findOne({
      userId: driverUserId,
    ...
    if (!driverDoc) {
      logger_1.logger.warn(
        `[TrackingService] Driver not found for user: ${driverUserId}`,
      );
      return;
    }
 ...
 */
const checkDriverArrival = (rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const checkDriverOnTheWay = (rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const tracking = yield tracking_model_1.Tracking.findOne({ rideId });
 ...
 */
const checkStopArrival = (rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const tracking = yield tracking_model_1.Tracking.findOne({ rideId });
    return { stopArrived: false, tracking: tracking || undefined };
  });
const createOrUpdateTracking = (userId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const ride = yield ride_model_1.Ride.findById(payload.rideId);
    if (!ride) {
    ...
    const tracking = yield tracking_model_1.Tracking.findOneAndUpdate(
      { rideId: payload.rideId },
      { $set: updateObj },
