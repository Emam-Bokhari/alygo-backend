...
router
    ...
    .get(authHelper_1.isAuthenticated, tier_controller_1.TierController.getAllTiers);
router
    .route("/:tierId")
    .get(authHelper_1.isAuthenticated, tier_controller_1.TierController.getTierById)
...
router.patch("/status/:tierId", authHelper_1.isAdmin, tier_controller_1.TierController.updateTierStatus);
