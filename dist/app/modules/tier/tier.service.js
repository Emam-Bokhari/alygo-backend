...
const createTierToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (existingTier) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.CONFLICT, "Tier with this name, code, or level already exists");
    }
...
const getAllTiersFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const searchableFields = ["name", "code"];
    const tiersQuery = new queryBuilder_1.default(tier_model_1.Tier.find({ isDeleted: false }), query)
...
const getTierByIdFromDB = (tierId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const tier = yield tier_model_1.Tier.findOne({ _id: tierId, isDeleted: false });
    if (!tier) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "Tier not found");
    }
    return tier;
});
const updateTierToDB = (tierId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(tierId)) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.NOT_ACCEPTABLE, "Invalid ID");
    }
    const isTierExist = yield tier_model_1.Tier.findOne({ _id: tierId, isDeleted: false });
    if (!isTierExist) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "Tier not found");
    }
    ...
    if (payload.code)
        orConditions.push({ code: payload.code });
    if (payload.level)
        orConditions.push({ level: payload.level });
...
const deleteTierToDB = (tierId) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(tierId)) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.NOT_ACCEPTABLE, "Invalid ID");
    }
    const isTierExist = yield tier_model_1.Tier.findOne({ _id: tierId, isDeleted: false });
...
const updateTierStatusToDB = (tierId, status) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(tierId)) {
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.NOT_ACCEPTABLE, "Invalid ID");
    }
    const tier = yield tier_model_1.Tier.findOne({ _id: tierId, isDeleted: false });
    ...
    const result = yield tier_model_1.Tier.findByIdAndUpdate(tierId, { status }, { new: true });
    if (!result) {
