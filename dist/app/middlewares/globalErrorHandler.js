...
const globalErrorHandler = (error, req, res, next) => {
    try {
        ...
        config_1.default.node_env === "development"
            ...
            : logger_1.errorLogger.error("🚨 globalErrorHandler", errorInfo);
    }
    catch (logError) {
        console.log("Error logging failed:", (logError === null || logError === void 0 ? void 0 : logError.message) || String(logError));
    }
    let statusCode = 500;
