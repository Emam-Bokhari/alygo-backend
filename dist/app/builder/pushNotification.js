    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        logger_1.logger.error(
          colors_1.default.red("❌ NotificationHelper Error:"),
          error,
        );
      }
    });
  ...
  sendChatMessage(chat, message) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        logger_1.logger.error(
          colors_1.default.red("❌ Error inside sendChatMessage:"),
          error,
        );
      }
    });
          ...
          return {
            ...
            referenceId:
              ((_a = payload.data) === null || _a === void 0
                ? void 0
                : _a.referenceId) || undefined,
            referenceModel:
              ((_b = payload.data) === null || _b === void 0
                ? void 0
                : _b.referenceModel) || undefined,
          };
        });
