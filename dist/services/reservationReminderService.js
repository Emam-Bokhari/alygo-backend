...
const processReservationReminders = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const systemConfig = yield (0, systemConfigHelper_1.getSystemConfig)();
        const configRes = systemConfig.reservation;
        if (!(configRes === null || configRes === void 0 ? void 0 : configRes.enabled))
            return;
        const now = new Date();
        ...
        logger_1.logger.error(`[ReservationReminderService] Error processing reminders: ${error.message}`);
    }
});
exports.processReservationReminders = processReservationReminders;
const sendReminderNotifications = (ride, intervalLabel) => __awaiter(void 0, void 0, void 0, function* () {
    const payload = Object.assign(Object.assign({ rideId: ride._id }, (0, timezoneHelper_1.getRideScheduleInfo)(ride)), { pickup: ride.pickup, destination: ride.destination, message: `Reminder: Your reservation ride is scheduled in ${intervalLabel}.` });
    // Socket notification to passenger
    socketHelper_1.socketHelper.sendToUser(ride.userId.toString(), "reservation-reminder", payload);
    ...
    if (driverUserId) {
        socketHelper_1.socketHelper.sendToUser(driverUserId.toString(), "reservation-reminder", payload);
        yield (0, notificationsHelper_1.sendNotifications)({
