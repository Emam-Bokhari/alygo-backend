 ...
 */
const findEligibleDriversInRadius = (_a) =>
  __awaiter(
    void 0,
    [_a],
    void 0,
    function* ({
      ...
      if (!resolvedRideServiceAreaId) {
        ...
        resolvedRideServiceAreaId =
          (_b =
            resolvedArea === null || resolvedArea === void 0
              ? void 0
              : resolvedArea._id) === null || _b === void 0
            ? void 0
            : _b.toString();
      }
      if (!resolvedRideServiceAreaId) {
      ...
      for (const driverDoc of nearbyDrivers) {
        ...
        if (
          !((_c = driverDoc.availability) === null || _c === void 0
            ? void 0
            : _c.canReceiveRide)
        ) {
          logger_1.logger.info(
        ...
        if (driverDoc.location && driverDoc.location.coordinates) {
          const [driverLongitude, driverLatitude] =
          ...
          if (driverLocServiceArea) {
            ...
            if (
              driverLocServiceArea.type === "city" &&
            ...
            policy =
              yield driverDutyPolicy_model_1.DriverDutyPolicy.findOne(query);
          }
        }
        if (policy) {
      ...
      if (candidates.length > 0) {
        try {
          ...
          if (
            !rideServiceArea.location ||
            !rideServiceArea.location.coordinates
          ) {
            logger_1.logger.warn(
          ...
          for (let i = 0; i < candidates.length; i++) {
            ...
            const pickupResult =
              (_d = matrix[i]) === null || _d === void 0 ? void 0 : _d[0];
            const serviceAreaCenterResult =
              (_e = matrix[i]) === null || _e === void 0 ? void 0 : _e[1];
            if (
              pickupResult &&
