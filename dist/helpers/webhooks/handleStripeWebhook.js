    ...
    switch (eventType) {
      case "checkout.session.completed": {
        ...
        if (metadata.type === "wallet_topup") {
          ...
          yield ride_service_1.RideServices.completeRidePayment(
            rideId,
            ride_constant_1.PAYMENT_METHOD.STRIPE,
            paymentIntent || {
              id: paymentIntentId,
          ...
          yield pendingPayment_service_1.PendingPaymentService.processCancellationFeePayment(
            session.id,
          );
        } else if (metadata.type === "driver_appreciation") {
          yield pendingPayment_service_1.PendingPaymentService.processDriverAppreciationPayment(
            session.id,
          );
        }
        break;
      ...
      case "charge.refunded": {
        ...
        yield transaction_model_1.Transaction.findOneAndUpdate(
          ...
          { paymentStatus: ride_constant_1.PAYMENT_STATUS.REFUNDED },
        );
        break;
      }
      case "payout.paid":
      ...
      case "account.updated": {
        ...
        let driver = null;
        if (
          (_a = account.metadata) === null || _a === void 0 ? void 0 : _a.userId
        ) {
          driver = yield driver_model_1.Driver.findOne({
        ...
        if (
          (_b = account.metadata) === null || _b === void 0 ? void 0 : _b.userId
        ) {
