...
exports.shouldRefreshETA =
  exports.validateLocationUpdate =
  exports.hasMovedMinimumDistance =
  exports.hasMinimumIntervalElapsed =
  exports.areCoordinatesDuplicate =
 ...
 */
const hasMinimumIntervalElapsed = (lastUpdateTime, minIntervalSeconds) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const now = new Date();
    const elapsedMs = now.getTime() - lastUpdateTime.getTime();
    const elapsedSeconds = elapsedMs / 1000;
    const interval =
      minIntervalSeconds !== null && minIntervalSeconds !== void 0
        ? minIntervalSeconds
        : (yield (0, systemConfigHelper_1.getSystemConfig)()).tracking
 ...
 */
const hasMovedMinimumDistance = (lat1, lon1, lat2, lon2) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // 0.0001 degrees is approximately 11 meters
    const minDelta = 0.0001;
    return (
      Math.abs(lat1 - lat2) >= minDelta || Math.abs(lon1 - lon2) >= minDelta
    );
  });
 ...
 */
const validateLocationUpdate = (params) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { newLat, newLon, oldLat, oldLon, lastUpdateTime, rideStatus } =
      params;
    ...
    if (
      !(yield (0, exports.hasMovedMinimumDistance)(
        newLat,
        newLon,
        oldLat,
        oldLon,
    ...
    if (
      lastUpdateTime &&
      !(yield (0, exports.hasMinimumIntervalElapsed)(lastUpdateTime))
    ) {
 ...
 */
const shouldRefreshETA = (lastETACalculatedAt, refreshIntervalSeconds) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const elapsedSeconds = elapsedMs / 1000;
    const interval =
      refreshIntervalSeconds !== null && refreshIntervalSeconds !== void 0
