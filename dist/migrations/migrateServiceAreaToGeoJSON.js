 ...
 */
const migrateServiceAreaToGeoJSON = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      logger_1.logger.info(
        `Found ${result.total} Service Area documents to process`,
      );
      for (const serviceArea of allServiceAreas) {
        try {
          ...
          if (
            ...
            result.skipped++;
            logger_1.logger.info(
              `Skipped ${serviceArea._id} - already has coordinates`,
            );
            continue;
          }
          ...
          const coordinates =
            yield googleMapsHelper_1.googleMapsHelper.geocode(locationString);
