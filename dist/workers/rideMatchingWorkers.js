...
exports.reservationReminderWorker =
  exports.driverAvailabilityWorker =
  exports.radiusExpansionWorker =
  exports.driverVisibilityWorker =
  exports.rideExpirationWorker =
    void 0;
...
const getTriggerFunction = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!triggerImmediateRadiusExpansion) {
      const rideService = yield Promise.resolve().then(() =>
        __importStar(require("../app/modules/ride/ride.service")),
      );
 ...
 */
const rideExpirationWorker = new bullmq_1.Worker(
  bullmq_2.QUEUE_NAMES.RIDE_EXPIRATION,
  (job) =>
    __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const driverVisibilityWorker = new bullmq_1.Worker(
  bullmq_2.QUEUE_NAMES.DRIVER_VISIBILITY,
  (job) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        ...
        if (driverNotification && driverNotification.status === "sent") {
          ...
          logger_1.logger.info(
            `Driver ${driverId} visibility expired for ride ${rideId}`,
          );
 ...
 */
const radiusExpansionWorker = new bullmq_1.Worker(
  bullmq_2.QUEUE_NAMES.RADIUS_EXPANSION,
  (job) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _a;
      const {
      ...
      try {
        ...
        const newRadius =
          currentRadiusKm +
          systemConfig.driverMatching.radiusExpansionDistanceKm;
        // Import and call the driver matching function
        const { findEligibleDriversInRadius } = yield Promise.resolve().then(
          () => __importStar(require("../services/driverMatchingService")),
        );
        const newDrivers = yield findEligibleDriversInRadius({
          ...
          rideServiceAreaId:
            (_a = ride.serviceAreaId) === null || _a === void 0
              ? void 0
              : _a.toString(),
        });
        if (newDrivers.length === 0) {
          ...
          if (newRadius < maxRadius) {
            ...
            yield bullmq_2.radiusExpansionQueue.add(
        ...
        newDrivers.forEach((driver) => {
          bullmq_2.driverVisibilityQueue.add(
 ...
 */
const driverAvailabilityWorker = new bullmq_1.Worker(
  bullmq_2.QUEUE_NAMES.DRIVER_AVAILABILITY_CHECK,
  (job) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        const now = new Date();
        ...
        for (const driver of driversToUpdate) {
          try {
            ...
            const availabilityData =
              yield driverDutyPolicy_service_1.DriverDutyPolicyServices.getDriverAvailability(
        ...
        logger_1.logger.error(
          "Error in driver availability worker:",
          error.message,
        );
        throw error;
      }
...
const reservationReminderWorker = new bullmq_1.Worker(
  bullmq_2.QUEUE_NAMES.RESERVATION_REMINDER,
  (job) =>
    __awaiter(void 0, void 0, void 0, function* () {
